...
const StudyMain = () => { 
  ...
  return (
    <div className='h-full'>
      <div className='h-[40%] border flex justify-center'>
        <img src={tableIcon} alt="테이블이미지" width="322" height="53" />
      </div>
      <div className='h-[60%] px-[30px] py-10 flex flex-col gap-[15px]'>
        <div
        ...
        >
          ...
          <div className='flex flex-col'>
            <p className='text-[12px] text-right'>다음 스터디 일정</p>
            <h2 className='text-right'>25년 6월 27일</h2>
          </div>
        </div>
        <div 
        ...
        >
          <div>이미지</div>
          <h2 className='text-right'>랭킹 보러가기</h2>
        </div>
        <div
          className='w-full h-[66px] rounded-xl bg-[#D9D9D9] flex items-center py-[10px] px-[20px] justify-between'
        ...
        >
          ...
          <div className='flex flex-col'>
            ...
            <h2 className='text-right'>게임 참가하기</h2>
          </div>
        </div>
        <div 
          className='w-full h-[66px] rounded-xl bg-[#D9D9D9] flex items-center py-[10px] px-[20px] justify-between'
        ...
        >
          ...
          <div className='flex flex-col'>
            ...
            <h2 className='text-right'>학습 시작하기</h2>
          </div>
        </div>
      </div>
    </div>
