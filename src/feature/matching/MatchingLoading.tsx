...
const MatchingLoading = () => {
    ...
    const loadingImage = 'https://via.placeholder.com/200x200/cccccc/000000?text=X';
    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 text-gray-800 p-4">
            ...
            <p className="text-xl md:text-3xl text-gray-700 text-center leading-relaxed">
                <span className="font-semibold">{userName}</span>님에게 알맞는
                <br />
                스터디룸 매칭 중이에요
            </p>

            {/* 로딩 이미지 영역 */}
            <div className="w-48 h-48 md:w-56 md:h-56 mt-16 mb-16 flex items-center justify-center bg-gray-200 rounded-md overflow-hidden">
                <img src={loadingImage} alt="로딩 이미지" className="w-full h-full object-cover" />
